...
- カットインの文字位置を修正し、見本の花束・ハート・雨・星・矢印・閃光と「成功！」の光の動きを調整しました。保存済みのカットインの内容は変えません。
...
- 2026-09-26に、前候補のカットイン見本とカード操作について利用者が画面確認を完了しました。今回の演出調整と一覧から引く操作の目視はこれからです。絵文字の見え方は端末のフォントに依存します。
