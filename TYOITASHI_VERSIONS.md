...
- 現在の候補：[6089e285](https://github.com/synchro4351/udonarium_axe/commit/6089e28581b3f218e4b34bf625650240578cbbaa)
- YouTubeカットイン開始時にiframeを生成し、自動再生を要求します。ブラウザの制限下では手動操作が必要です。
- ホットバーのエフェクト選択に図形アイコンと名称を併記しました。
- 編集可能なカットイン見本を15種に拡充しました。透明背景・短時間で、外部画像・音声は不要です。
...
- 全体12,555件成功・1件skip、production build成功。エフェクト選択欄・見本の演出・カード機能の目視、2クライアントの実動作、カード追加項目のセーブ再読込は未確認です。山札の通信遅延自体の解消は未確認です。
- [r1からの差分](https://github.com/synchro4351/udonarium_axe/compare/be1fdb8a81037efab6300ad49260023552e87739...6089e28581b3f218e4b34bf625650240578cbbaa)
