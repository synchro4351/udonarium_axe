...
- 現在の候補：[4e1e2715](https://github.com/synchro4351/udonarium_axe/commit/4e1e2715)
...
- 結合候補の全体テストで12,646件成功・1件skip、production build成功。エフェクト選択欄・見本の演出・新しいカード操作の目視、2クライアントの実動作、追加設定のセーブ再読込は未確認です。山札の通信遅延自体の解消は未確認です。
- [r1からの差分](https://github.com/synchro4351/udonarium_axe/compare/be1fdb8a81037efab6300ad49260023552e87739...4e1e2715)
